...
class MainContent extends Component {
  ...
  state = {
    ...
    movieInfo: [
      ...
      {
        title: 'Trending Now',
        url: `/trending/all/week?api_key=9d2bff12ed955c7f1f74b83187f188ae&language=en-US`,
        movies: [],
      },
      {
        title: 'Top Rated',
        url: `/movie/top_rated?api_key=9d2bff12ed955c7f1f74b83187f188ae&language=en-US`,
        movies: [],
      },
      {
        title: 'Action Movies',
        url: `/discover/movie?api_key=9d2bff12ed955c7f1f74b83187f188ae&with_genres=28`,
        movies: [],
      },
      {
        title: 'Comedy Movies',
        url: `/discover/tv?api_key=9d2bff12ed955c7f1f74b83187f188ae&with_genres=35`,
        movies: [],
      },
      {
        title: 'Horror Movies',
        url: `/discover/tv?api_key=9d2bff12ed955c7f1f74b83187f188ae&with_genres=27`,
        movies: [],
      },
      {
        title: 'Documentaries',
        url: `/discover/tv?api_key=9d2bff12ed955c7f1f74b83187f188ae&with_genres=99`,
        movies: [],
      },
    ],
  };
  ...
  getMovie = () => {
    ...
    const url = `https://api.themoviedb.org/3/tv/${movieId}?api_key=9d2bff12ed955c7f1f74b83187f188ae`;
    axios
      .get(url)
      .then(res => {
