...
export function fetchTrending() {
  const request = axios.get(
    `/trending/all/week?api_key=9d2bff12ed955c7f1f74b83187f188ae&language=en-US`
  );
...
export function fetchTopRated() {
  const request = axios.get(
    `/movie/top_rated?api_key=9d2bff12ed955c7f1f74b83187f188ae&language=en-US`
  );
...
export function fetchActionMovies() {
  const request = axios.get(
    `/discover/movie?api_key=9d2bff12ed955c7f1f74b83187f188ae&with_genres=28`
  );
...
export function fetchComedyMovies() {
  const request = axios.get(
    `/discover/movie?api_key=9d2bff12ed955c7f1f74b83187f188ae&with_genres=35`
  );
...
export function fetchHorrorMovies() {
  const request = axios.get(
    `/discover/movie?api_key=9d2bff12ed955c7f1f74b83187f188ae&with_genres=27`
  );
...
export function fetchRomanceMovies() {
  const request = axios.get(
    `/discover/movie?api_key=9d2bff12ed955c7f1f74b83187f188ae&with_genres=10749`
  );
...
export function fetchDocumentaries() {
  const request = axios.get(
    `/discover/movie?api_key=9d2bff12ed955c7f1f74b83187f188ae&with_genres=99`
  );
